...
const makeBookElement = (bookObject) => {
  ...
  elementBookAuthor.innerHTML = `${bookObject.year} -<span> ${bookObject.author}</span>`;
  ...
  if (bookObject.isComplete) {
    ...
    returnBtn.innerHTML = `<i class="fa-solid fa-clock-rotate-left fa-xs"></i>`;
    ...
    finishBtn.innerHTML = `<i class="fa-solid fa-check fa-xs"></i>`;
